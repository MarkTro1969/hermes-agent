...
DEFAULT_CONFIG = {
    ...
    "skills": {
        ...
        # System-prompt discovery index: "full" includes name + description; "names" keeps every
        # discoverable skill name but omits descriptions. skill_view/skills_list remain unchanged.
        "prompt_catalog": "full",
